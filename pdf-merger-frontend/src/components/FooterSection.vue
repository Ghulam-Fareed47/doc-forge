      ...
      <div class="flex flex-col space-y-6">
        ...
        <div class="text-center">
          <p class="text-gray-500 text-sm">
            Fast, secure, and free PDF merging tool. Combine your documents in seconds.
          </p>
          <p class="text-gray-500 font-medium mt-6">
            © {{ currentYear }} PDF Merger. Built using Vue + Laravel
          </p>
        </div>
...
const socialLinks = [
  ...
  { name: 'LinkedIn', url: 'https://linkedin.com', icon: 'fab fa-linkedin', color: '#0A66C2' },
