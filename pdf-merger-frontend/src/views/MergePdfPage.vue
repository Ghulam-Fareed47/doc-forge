    ...
    <div
        ...
        <section class="py-16 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800">
            <div class="container mx-auto px-4 max-w-5xl">
                <div class="text-center mb-12">
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-3">How to Merge PDFs</h2>
                    <p class="text-sm md:text-base text-gray-600 dark:text-gray-400">Combine your files in three simple
                        steps</p>
                </div>
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="text-center group">
                        <div
                            class="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                            <span class="text-xl font-bold">1</span>
                        </div>
                        <h3 class="text-base font-bold text-gray-900 dark:text-white mb-2">Select Files</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Click the upload area or drag and drop your
                            PDF files into the tool.</p>
                    </div>
                    <div class="text-center group">
                        <div
                            class="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                        ...
                        <h3 class="text-base font-bold text-gray-900 dark:text-white mb-2">Reorder PDFs</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Drag files to arrange them in the exact
                            order you want them to appear.</p>
                    </div>
                    <div class="text-center group">
                        <div
                            class="w-12 h-12 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                        ...
                        <h3 class="text-base font-bold text-gray-900 dark:text-white mb-2">Merge & Download</h3>
                        <p class="text-xs text-gray-500 dark:text-gray-400">Click "Merge Now" and your files will be
                            processed instantly in your browser.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-16 bg-gray-50 dark:bg-slate-900">
            <div class="container mx-auto px-4 max-w-5xl">
                <div class="grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-6">Why Use Our PDF
                            Merger?</h2>
                        <div class="space-y-4">
                            <div v-for="(feature, index) in toolFeatures" :key="index" class="flex gap-4">
                                ...
                                <div>
                                    <h4 class="text-sm font-bold text-gray-900 dark:text-white mb-1">{{ feature.title }}
                                    </h4>
                    ...
                    <div class="relative">
                        <div class="aspect-video rounded-2xl overflow-hidden shadow-2xl">
                            <img src="https://images.unsplash.com/photo-1568667256549-094345857637?auto=format&fit=crop&q=80&w=800"
                                alt="Professional PDF Management" class="w-full h-full object-cover">
                        </div>
                        <div
                            ...
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span class="text-[10px] font-bold uppercase tracking-wider text-gray-500">Bank-Level
                                    Security</span>
                            </div>
                            <div class="text-xs font-bold text-gray-900 dark:text-white">100% Private Processing</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="py-16 bg-white dark:bg-gray-900">
            <div class="container mx-auto px-4 max-w-3xl">
                <div class="text-center mb-12">
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-3">Frequently Asked
                        Questions</h2>
                    <p class="text-sm md:text-base text-gray-600 dark:text-gray-400">Everything you need to know about
                        merging PDFs</p>
                </div>
                <div class="space-y-4">
                    <div v-for="(faq, index) in faqs" :key="index"
                        class="border border-gray-100 dark:border-gray-800 rounded-xl overflow-hidden hover:border-blue-200 dark:hover:border-blue-900 transition-colors">
                        ...
                        <transition enter-active-class="transition-all duration-300"
                            ...
                            leave-active-class="transition-all duration-200" leave-from-class="max-h-40 opacity-100"
...
const faqs = ref([
    { question: 'Is it safe to merge PDFs here?', answer: 'Absolutely. All processing happens directly in your browser. Your files are never uploaded to any server, ensuring 100% privacy and bank-level security.', isOpen: false },
    { question: 'Is there a limit to how many files I can merge?', answer: 'For guest users, there are daily limits to ensure platform stability. Registered users enjoy higher limits and more features.', isOpen: false },
    { question: 'Will the merged PDF lose quality?', answer: 'No. Our tool maintains the original resolution and quality of your PDF documents during the merging process.', isOpen: false },
    { question: 'Can I reorder the files?', answer: 'Yes! After uploading, you can use the arrow buttons next to each file to arrange them in your preferred sequence.', isOpen: false }
])

const toolFeatures = [
    { title: 'Privacy Guaranteed', description: 'Your documents never leave your local machine. We use client-side processing core.' },
    { title: 'Blazing Fast', description: 'Experience zero-upload latency. Merge your PDFs instantly with our optimized engine.' },
    { title: 'Quality Preserved', description: 'High-fidelity output ensuring that text, images, and formatting remain intact.' },
    { title: 'Fully Responsive', description: 'Access our tools comfortably from your phone, tablet, or desktop anywhere.' }
]
