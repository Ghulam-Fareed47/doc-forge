            ...
            <div class="bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 p-8">
                ...
                <label for="file-upload" class="cursor-pointer block">
                  <div class="flex flex-col items-center justify-center">
                    <div
                      ...
                      <i class="fas fa-tint text-4xl text-primary-600 dark:text-primary-400"></i>
                    </div>
              ...
              <div v-if="selectedFile" class="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <input v-model.number="opacity" type="range" min="0" max="1" step="0.1" value="0.5" class="w-full" />
